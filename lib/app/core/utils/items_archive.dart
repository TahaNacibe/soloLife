...
Map<String, dynamic> archive = {
  ...
  //? Box's Items List
  "Myst'sBox" :ShopItem(title:"Myst'sBox",image:"assets/images/items/box/newBox.png", price: 15000,itemType: "Box",id:"Myst'sBox",rarity:5),
  "Myst'sBoxCurse": ShopItem(title:"Myst'sBox Curse",image:"assets/images/items/box/cursedBox.png", price: 10000,itemType: "Box",id:"Myst'sBoxCurse",rarity:4),
  "Myst'sBoxOld":ShopItem(title:"Myst'sBox Old",image:"assets/images/items/box/oldBox.png", price: 5000,itemType: "Box",id:"Myst'sBoxOld",rarity:3),
  "CoinsBag":ShopItem(title: "coins bag", image: "assets/images/items/box/runsBag.png", price: 0, itemType: "coins", id: "CoinsBag",rarity:3),
  //? Runes Item List
  "StrengthRune":ShopItem(title:"Strength Rune",image:"assets/images/items/full/strength_full.png", price: 1500,itemType: "Rune", id: "StrengthRune",rarity:6),
  "SenseRune":ShopItem(title:"Sense Rune",image:"assets/images/items/full/sense_full.png", price: 1500,itemType: "Rune", id: "SenseRune",rarity:6),
  "AgilityRune":ShopItem(title:"Agility Rune",image:"assets/images/items/full/agility_full.png", price: 1500,itemType: "Rune", id: "AgilityRune",rarity:6),
  "IntelligenceRune":ShopItem(title:"Intelligence Rune",image:"assets/images/items/full/intelligence_full.png", price: 1500,itemType: "Rune", id: "IntelligenceRune",rarity:6),
  "ManaRune":ShopItem(title:"Mana Rune",image:"assets/images/items/full/mana_full.png", price: 1500,itemType: "Rune", id: "ManaRune",rarity:6),
  "VitalityRun":ShopItem(title:"Vitality Rune",image:"assets/images/items/full/vitality_full.png", price: 1500,itemType: "Rune", id: "VitalityRun",rarity:6),
  //? Runes Items medium List
  "StrengthRuneMedium":ShopItem(title:"Strength Fragment",image:"assets/images/items/medium/strength_medium.png", price: 1500,itemType: "Rune", id: "StrengthRuneMedium",rarity:5),
  "SenseRuneMedium":ShopItem(title:"Sense Fragment",image:"assets/images/items/medium/sense_medium.png", price: 1500,itemType: "Rune", id: "SenseRuneMedium",rarity:5),
  "AgilityRuneMedium":ShopItem(title:"Agility Fragment",image:"assets/images/items/medium/agility_medium.png", price: 1500,itemType: "Rune", id: "AgilityRuneMedium",rarity:5),
  "IntelligenceRuneMedium":ShopItem(title:"Intelligence Fragment",image:"assets/images/items/medium/intelligence_medium.png", price: 1500,itemType: "Rune", id: "IntelligenceRuneMedium",rarity:5),
  "ManaRuneMedium":ShopItem(title:"Mana Fragment",image:"assets/images/items/medium/mana_medium.png", price: 1500,itemType: "Rune", id: "ManaRuneMedium",rarity:5),
  "VitalityRunMedium":ShopItem(title:"Vitality Fragment",image:"assets/images/items/medium/vitality_medium.png", price: 1500,itemType: "Rune", id: "VitalityRunMedium",rarity:5),
  //? Runes Items small List
  "StrengthRuneSmall":ShopItem(title:"Strength Shard ",image:"assets/images/items/small/strength_small.png", price: 1500,itemType: "Rune", id: "StrengthRuneSmall",rarity:4),
  "SenseRuneSmall":ShopItem(title:"Sense Shard ",image:"assets/images/items/small/sense_small.png", price: 1500,itemType: "Rune", id: "SenseRuneSmall",rarity:4),
  "AgilityRuneSmall":ShopItem(title:"Agility Shard ",image:"assets/images/items/small/agility_small.png", price: 1500,itemType: "Rune", id: "AgilityRuneSmall",rarity:4),
  "IntelligenceRuneSmall":ShopItem(title:"Intelligence Shard ",image:"assets/images/items/small/intelligence_small.png", price: 1500,itemType: "Rune", id: "IntelligenceRuneSmall",rarity:4),
  "ManaRuneSmall":ShopItem(title:"Mana Shard ",image:"assets/images/items/small/mana_small.png", price: 1500,itemType: "Rune", id: "ManaRuneSmall",rarity:4),
  "VitalityRunSmall":ShopItem(title:"Vitality Shard ",image:"assets/images/items/small/vitality_small.png", price: 1500,itemType: "Rune", id: "VitalityRunSmall",rarity:4),
  };
