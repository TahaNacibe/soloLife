                    ...
                    child: Column(
                      children: [
                        Row(
                          ...
                          children: [
                            actionBarItem("onGoing", "${onGoing.length}",
                                Colors.purple, false, 20, 18),
                            actionBarItem("Finished", "${finished.length}",
                                Colors.purple, false, 20, 18),
                            actionBarItem("Tasks", "$totalTodos", Colors.purple,
                                false, 20, 18),
                          ],
                        ),
                        Padding(
                      ...
                      decoration: InputDecoration(
                          ...
                          suffixIcon: IconButton(
                            onPressed: () {
                              ...
                              if (title.isNotEmpty) {
                                int point =
                                    userInfo.keys!.contains("monster") ? 2 : 1;
                                if (isExist(title)) {
                                  ...
                                  addTask(
                                      title,
                                      isFree,
                                      getExpForTheTasks(level, isFree) * point,
                                      time,
                                      getCoinsForTheTasks(isFree));
                ...
                children: [
                  ...
                  if (onGoing.isEmpty)
                    const Padding(
                      ...
                      child: Text("No Quests Left For Today",
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize: 22,
                              fontFamily: "Quick")),
                  ...
                  ReorderableListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (task.standard) {
                        Map quest = mainQuests(task.title, level,
                            userInfo.keys!.contains('monster'));
                        return Padding(
                          key: ObjectKey(index),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (task.standard) {
                        ...
                        return Dismissible(
                          ...
                          confirmDismiss: (_) async {
                            bottomShit(context, finished[index], () {
                              //! why ongoing when did i change that one!!!
                              setState(() {});
                            });
                            return false;
                          },
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Text(
                                "You wont get any Exp or Credit if you delete it",
                                style: TextStyle(
                                    fontFamily: "Quick",
                                    fontWeight: FontWeight.w600),
                              ),
