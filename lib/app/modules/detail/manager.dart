              ...
              return Padding(
                ...
                child: Dismissible(
                  onDismissed:(_){
                    ...
                    BudgetProvider().writeBudget(log);
                    setState(() {});
                  },
                  ...
                  child: GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      padding: EdgeInsets.all(4),
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(15),
                              ...
                              boxShadow:[BoxShadow(
                              color: Theme.of(context).shadowColor.withOpacity(.7), // Shadow color
                      ...
                      child: Column(
                        children: [
                          ListTile(
                            title: Text(log[itemIndex].dateTime,
                            style: const TextStyle(fontWeight: FontWeight.w600,fontFamily: "Quick"),),
                            leading: Text('${state? '+' : '-'}${amount}',style: TextStyle(
                              color:state? Colors.green : Colors.red,
                              fontFamily: "Quick",
                              fontSize: 16,
                              fontWeight: FontWeight.bold
                            ),),
                            trailing: Text(state? "Deposit" : "Withdraw"
                            ,style: TextStyle(
                              fontFamily: "Quick",
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                                    ...
                                    Padding(
                                      ...
                                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                        children: [
                                          if(!editing)
                                        Expanded(
                                          child: Text(log[itemIndex].record.isNotEmpty? log[itemIndex].record: "No Record For That Entry",
                                          softWrap: true,
                                          maxLines: 3,
                                        ...
                                        GestureDetector(
                                          onTap:(){
                                            editing = !editing;            
                                            if(editing){
                                            recordController.text = log[index].record;
                                            }
                                            log[index].record = recordController.text;
                                            BudgetProvider().writeBudget(log);
                                            if(!editing){
                   ...
                   children: [
                     ...
                     Container(padding: const EdgeInsets.all(8),
                                  ...
                                  child: GestureDetector(onTap: (){
                                    revenues = !revenues;
                                                setState((){});
                                  }, child: Text(revenues?"Deposit" : "Withdraw",style: const TextStyle(color:Colors.white,fontFamily: "Quick",fontWeight: FontWeight.bold),)),),
                   ],
                 ),
                  Padding(
                   padding: const EdgeInsets.all(8.0),
                   child: Text.rich(
                    TextSpan(children:[
                       TextSpan(text: "Last Action Record :",
                      ),
                          ...
                          child: TextField(
                           ...
                           child: Container(
                                ...
                                child: IconButton(onPressed:(){
                                  int amount = double.parse(controller.text).toInt();
                                    List<Budget> budget = BudgetProvider().readBudget();
                                      Budget newBudget = Budget(
                                        dateTime: formatDateTime(DateTime.now(),true), 
                                        amount:amount, add: revenues);
