            ...
            children: [
              Container(
                ...
                child: Column(children: [
                  ...
                  Obx(() {
                    // Initializing variables to observation by the obx
                    var totalTodos =
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              actionBarItem("onGoing", "$ongoingTodo", color,
                                  false, 20, 18),
                              actionBarItem("Finished", "$doneTodo", color,
                                  false, 20, 18),
                              actionBarItem(
                                  "Tasks", "$totalTodos", color, false, 20, 18),
                            ],
                          ),
                          Padding(
