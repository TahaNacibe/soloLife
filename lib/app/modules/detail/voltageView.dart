...
class _VoltageViewState extends State<VoltageView> {
  ...
  List<Volt> Negative =yourVoltage.where((volt) => !volt.isPositive).toList(); 
                ...
                child: CircularStepProgressIndicator(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                                          decoration: 
                                          BoxDecoration(
                                            color:isShowing? Colors.white: Theme.of(context).cardColor.withOpacity(.5),
                                          ...
                                          radius: 35,
                                          backgroundImage: 
                                          AssetImage('assets/images/thunder.gif') as ImageProvider,
                                              ),),
                        ),
                ),
              ),
              Padding(
                ...
                child: Container(padding: EdgeInsets.all(12),
                  decoration: BoxDecoration(
                    ...
                    boxShadow:[BoxShadow(
                          color: Colors.teal.withOpacity(.8), // Shadow color
                    ...
                    color: Colors.teal),
                  child: Text("Voltage: $voltageLevel",
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                            ...
                            suffixIcon: IconButton(
                              ...
                              if (title.isNotEmpty) {
                                Volt entry = Volt(title: title,isPositive: isPositive);
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Container(
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(yourVoltage[index].title,
                                        softWrap: true,
                                      ...
                                      Padding(
                                        ...
                                        decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(12),
                                          border: Border.all(color: yourVoltage[index].isPositive? Colors.green : Colors.red,width: 2)
                                          ),
                                          child: Text(
                                            style: TextStyle(
                                              fontFamily: "Quick",
                                              fontSize: 15,
                                              fontWeight: FontWeight.bold,
                                              color:yourVoltage[index].isPositive
                                              ? Colors.green : Colors.red),
                                               yourVoltage[index].isPositive
                                              ? " Positive" 
                                              : " Negative"),
                                        ),
                                      )]),
